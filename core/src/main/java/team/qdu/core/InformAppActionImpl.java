...
public class InformAppActionImpl implements InformAppAction {
    ...
    //获取当前班课的消息
    @Override
    public void getInform(final String classId, final ActionCallbackListener<List<Inform>> listener) {
    ...
    @Override
    public void deleteInform(final String inform_id, final ActionCallbackListener<Void> listener) {
        new AsyncTask<Void, Void, ApiResponse<Void>>() {
    ...
    @Override
    public void createInform(final String classid,final String detail,final ActionCallbackListener<Void> listener){
        new AsyncTask<Void, Void, ApiResponse<Void>>() {
