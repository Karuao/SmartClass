...
public class SignInHistoryForTeacherAdapter extends SBaseAdapter<Attendance> {
    ...
    public SignInHistoryForTeacherAdapter(Context context, List itemList) {
        super(context);
...
//        String classMember = ((TextView)convertView.findViewById(R.id.classMember)).getText().toString();
//        compo.totalClassMember.setText(classMember);
        return convertView;
    }
}
