...
public class ChangeInfoActivity extends SBaseActivity {
    ...
    public void showSelectPopup(View view) {
        if (selectphotoPopup == null) {
            View contentView = LayoutInflater.from(ChangeInfoActivity.this)
    ...
    private void handleCropResult(Intent result) {
        ...
        if (null != resultUri) {
            Bitmap bitmap = null;
            try {
                bitmap = MediaStore.Images.Media.getBitmap(ChangeInfoActivity.this.getContentResolver(), resultUri);
            ...
            Toast.makeText(ChangeInfoActivity.this, "无法剪切选择图片", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void handleCropError(Intent result) {
        ...
        if (cropError != null) {
            ...
            Toast.makeText(ChangeInfoActivity.this, cropError.getMessage(), Toast.LENGTH_LONG).show();
        } else {
            Toast.makeText(ChangeInfoActivity.this, "无法剪切选择图片", Toast.LENGTH_SHORT).show();
        }
    }
