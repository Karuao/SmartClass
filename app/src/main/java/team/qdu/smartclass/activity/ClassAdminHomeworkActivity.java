...
public class ClassAdminHomeworkActivity extends SBaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.class_tab03_admin);
        initView();
        initEvents();
    }
    ...
    private void initView() {
        ...
        //页面切换
        viewPager = (ViewPager) findViewById(R.id.class_tab03_admin_viewpager);
        ...
        View tab01 = mInflater.inflate(R.layout.class_tab03_admin_underway, null);
        View tab02 = mInflater.inflate(R.layout.class_tab03_admin_finish, null);
